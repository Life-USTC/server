...
const E2E = {
  ...
  adminExperience: "src/app/admin/audit/test.ts",
...
export const PAGE_INVENTORY: readonly PageInventoryEntry[] = [
  ...
  {
    routeId: "/admin/experience",
    samplePath: "/admin/experience",
    kind: "page",
    auth: "admin",
    contractPath: "/admin/experience",
    e2eSpec: E2E.adminExperience,
    mobileScreenshots: ["admin"],
    primaryActions: [
      {
        id: "experience-window",
        role: "link",
        name: "/最近 30 .*完整|Last 30 full days/i",
        e2eSpec: E2E.adminExperience,
      },
      {
  ...
  },
  {
    ...
    kind: "page",
    auth: "public",
    contractPath: "/catalog/young-events",
    e2eSpec: E2E.youngEvents,
    mobileScreenshots: ["public"],
    primaryActions: [
      {
        id: "search-young-events",
        e2eSpec: E2E.youngEvents,
        evidence: "搜索、报名状态筛选与清除按钮",
      },
    ],
  },
  {
    ...
    kind: "page",
    auth: "public",
    contractPath: "/catalog/young-events/[youngId]",
    e2eSpec: E2E.youngEventsYoungId,
    mobileScreenshots: ["public"],
    primaryActions: [
      {
        id: "back-to-young-events",
        role: "link",
        e2eSpec: E2E.youngEventsYoungId,
      },
    ],
