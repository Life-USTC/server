...
describe("sitemap route", () => {
  ...
  it("preserves canonical URLs and excludes retired Sections", async () => {
    ...
    expect(
      ...
      "https://life.example/",
      "https://life.example/catalog/courses",
      "https://life.example/catalog/sections",
      "https://life.example/catalog/teachers",
      ...
      "https://life.example/usage/mcp",
      "https://life.example/usage/cli",
