...
$: callbackJson = JSON.stringify(callbackPayload, null, 2);
</script>
...
<main class="grid gap-4">
  <Card.Root>
    <Card.Header>
      <Card.Title>
        <h1>OAuth E2E Callback</h1>
      </Card.Title>
      <Card.Description>Captured callback parameters for OAuth integration flows.</Card.Description>
    </Card.Header>
    <Card.Content>
