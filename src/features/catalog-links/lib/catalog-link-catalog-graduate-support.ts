...
export const USTC_GRADUATE_AND_SUPPORT_LINKS: CatalogLinkItem[] = [
  {
    ...
    localizations: {
      "en-us": {
        title: "Graduate Service Platform",
        description: "Comprehensive graduate affairs platform.",
      },
    },
    category: "academic",
    icon: "graduation-cap",
  },
  {
    ...
    localizations: {
      "en-us": {
        title: "EPC Platform",
        description: "Graduate training process platform.",
      },
    },
    category: "academic",
    icon: "graduation-cap",
  },
  {
    ...
    localizations: {
      "en-us": {
        ...
        description: "Official Graduate School website.",
      },
    },
    category: "academic",
    icon: "school",
  ...
  },
  {
    ...
    localizations: {
      "en-us": {
        ...
        description: "High-performance computing resources entry.",
      },
    },
    category: "services",
    icon: "network",
  },
  {
    ...
    localizations: {
      "en-us": {
        ...
        description: "Campus hospital and medical services.",
      },
    },
    category: "campus",
    icon: "building",
  },
  {
    ...
    localizations: {
      "en-us": {
        title: "Transcript Printing",
        description: "Transcript printing and verification.",
      },
    },
    category: "academic",
    icon: "clipboard-list",
  },
  {
    ...
    localizations: {
      "en-us": {
        title: "Welcome Site",
        description: "New student registration and welcome information.",
      },
    },
    category: "campus",
    icon: "school",
  },
  {
    ...
    localizations: {
      "en-us": {
        ...
        description: "Admissions policies and notices.",
      },
    },
    category: "campus",
    icon: "graduation-cap",
  },
  {
    ...
    localizations: {
      "en-us": {
        title: "Teaching Equipment Repair",
        description: "Teaching equipment repair requests.",
      },
    },
    category: "services",
    icon: "clipboard-list",
