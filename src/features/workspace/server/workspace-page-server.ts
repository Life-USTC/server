...
export async function getWorkspaceUserId(request: Request) {
...
export function normalizeWorkspaceTab(tab: string | null, signedIn: boolean) {
  if (signedIn && isWorkspaceTab(tab)) return tab;
