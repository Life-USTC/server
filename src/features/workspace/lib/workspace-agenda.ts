...
export function buildWorkspaceAgendaDays<
...
>(input: {
  ...
  locale: string;
  startKey: string;
  timelineItemsForDay: (events: Events) => WorkspaceTimelineItem[];
}): WorkspaceAgendaDay[] {
...
export function workspaceReferenceTime(
...
export function currentWorkspaceTimedEventKey(
...
export function workspaceFocusItem(input: {
