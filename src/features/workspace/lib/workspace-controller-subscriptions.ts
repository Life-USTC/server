...
export async function matchWorkspaceImportSections(input: {
...
export async function confirmWorkspaceImportSections(input: {
  copy: SubscriptionsCopy;
  selectedSectionIds: number[];
}) {
  try {
...
export async function removeWorkspaceSubscribedSection(input: {
  copy: SubscriptionsCopy;
  sectionId: number;
}) {
  try {
