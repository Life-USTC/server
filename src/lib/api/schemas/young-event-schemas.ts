...
export const youngEventSummarySchema = z.strictObject({
  ...
  activityStatusCode: z.string().nullable(),
  signupStatusCode: z.string().nullable(),
  requiresSignup: z.boolean().nullable(),
  categoryCode: z.string().nullable(),
  moduleCode: z.string().nullable(),
  formCode: z.string().nullable(),
  activityLevelCode: z.string().nullable(),
  departmentId: z.string().nullable(),
  upstreamOrganizerIds: z.array(z.string()),
  upstreamSponsorIds: z.array(z.string()),
  tagIds: z.array(z.string()),
  signupScopeCode: z.string().nullable(),
  signupDepartmentIds: z.array(z.string()),
  requiresSignupInfo: z.boolean().nullable(),
  allowedAttachmentTypes: z.array(z.string()),
  isOnline: z.boolean().nullable(),
  onlineMeetingInfo: z.string().nullable(),
  externalSponsor: z.string().nullable(),
