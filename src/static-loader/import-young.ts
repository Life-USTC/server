  ...
  await bulkUpsert(
    ...
    builds.map((build) => ({
      ...
      values: [
        ...
        build.moduleCode,
        build.formCode,
        build.activityLevelCode,
        build.departmentId,
        build.upstreamOrganizerIds ?? [],
        build.upstreamSponsorIds ?? [],
        build.tagIds ?? [],
        build.signupScopeCode,
        build.signupDepartmentIds ?? [],
        build.requiresSignupInfo,
        build.allowedAttachmentTypes ?? [],
        build.isOnline,
        build.onlineMeetingInfo,
        build.externalSponsor,
