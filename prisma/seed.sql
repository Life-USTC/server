...
INSERT INTO public."Schedule" (id, periods, date, weekday, "startTime", "endTime", experiment, "customPlace", "lessonType", "weekIndex", "exerciseClass", "startUnit", "endUnit", "roomId", "sectionId", "scheduleGroupId") VALUES (4, 2, '2026-05-03', 7, 1400, 1545, NULL, NULL, NULL, 2, NULL, 7, 8, 1, 3, 5) ON CONFLICT DO NOTHING;
...
INSERT INTO public."Schedule" (id, periods, date, weekday, "startTime", "endTime", experiment, "customPlace", "lessonType", "weekIndex", "exerciseClass", "startUnit", "endUnit", "roomId", "sectionId", "scheduleGroupId") VALUES (8, 2, '2026-05-02', 6, 830, 1015, NULL, NULL, NULL, 2, NULL, 1, 2, 1, 3, 3) ON CONFLICT DO NOTHING;
